"""
Django settings for vivekweb project.
...
SECRET_KEY = '*j6-i+#93o0e*fk%5lov3!jml$=v^_j(uc5+*!=o$ipcy%w&^t'
...
WSGI_APPLICATION = 'vivekweb.wsgi.application'
